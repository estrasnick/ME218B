/****************************************************************************
 ...
 When           Who     What/Why
 -------------- ---     --------
 02/08/12 01:39 jec      converted from MW_MasterTemplateMachine.c
...
// away without it
static MasterTemplateState_t CurrentState;
...
****************************************************************************/
bool InitMasterTemplateTemplateSM ( uint8_t Priority )
{
  ES_Event ThisEvent;
  ...
  // Start the MasterTemplate State machine

  StartMasterTemplateSM( ThisEvent );
...
ES_Event RunMasterTemplateSM( ES_Event CurrentEvent )
{
   ...
   MasterTemplateState_t NextState = CurrentState;
    ...
    switch ( CurrentState )
   {
    ...
    if (MakeTransition == true)
    {
       ...
       RunMasterTemplateSM(CurrentEvent);

       CurrentState = NextState; //Modify state variable

       // Execute entry function for new state
       // this defaults to ES_ENTRY
       RunMasterTemplateSM(EntryEventKind);
     }
