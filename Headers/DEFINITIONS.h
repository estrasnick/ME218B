...
#define HALLSENSOR_INTERRUPT_PRIORITY	0
...
#define FLYWHEEL_GEAR_RATIO 1 // NOTE: This is not final!!!
...
#define DEFAULT_DRIVE_RPM 100.0f
#define NOT_IN_QUEUE 0x30

#define PRI_DISTANCE_MULTIPLIER 1
#define PRI_CAPTURE_HISTORY_MULTIPLIER 70
#define RETRY_MULTIPLIER 30

#define NULL_BEACON 5

#define HALL_SENSOR_OFFSET_IN_TICKS 40
...
#define CANNON_SLOPE_MULTIPLIER .72f

#define POSITION_TIMEOUT_THRESHOLD 50

#define SPEED_CHECK_LIMIT 625
